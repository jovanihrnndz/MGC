export const services = [
  {
    ...
    shortDescription:
      "Complete kitchen transformations — cabinets, countertops, plumbing, electrical, and finishes.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Modern bathrooms with quality tile, fixtures, and finishes. We handle every trade.",
    description:
  ...
  },
  {
    ...
    slug: "room-additions",
    shortDescription:
      "Expand your living space with permitted, inspected additions that blend seamlessly.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Ground-up construction of your forever home. Foundation to finish, fully managed.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Drywall, flooring, doors, windows, and structural repairs — big or small.",
    description:
  ...
  },
  {
    ...
    slug: "commercial-ti",
    shortDescription:
      "Office, retail, and restaurant buildouts. On-time, on-budget commercial construction.",
    description:
